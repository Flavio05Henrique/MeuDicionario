...
namespace MeuDicionarioV2.Core.Messaging
{
        ...
        where TResponse : Result
    {
        ...
        protected void AddErro(string mesagem)
        {
            ValidationResult.Errors.Add(new ValidationFailure(string.Empty, mesagem));
        }

        protected void AddErros(ValidationResult validationResult)
        {
